          ...
          <ul className="space-y-2">
            ...
            <li>
              <button
                ...
                className={`w-full text-left py-2 px-4 hover:bg-white hover:text-black rounded ${activeForm === 'create' ? 'bg-purple-900' : ''}`}
              >
                Create Event
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left py-2 px-4  hover:bg-white hover:text-black rounded ${activeForm === 'update' ? 'bg-purple-900' : ''}`}
              >
                Update Event
              </button>
            </li>
            <li>
              <button
                ...
                className={`w-full text-left py-2 px-4  hover:bg-white hover:text-black rounded ${activeForm === 'delete' ? 'bg-purple-900' : ''}`}
              >
                Delete Event
              </button>
            </li>
