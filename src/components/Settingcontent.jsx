...
const SettingsContent = () => (
  <div className="p-8 bg-gray-300 flex-grow text-black">
    ...
    <div>
      ...
      <form className="space-y-4  ">
        <div className="flex space-x-4 ">
          <input type="text" placeholder="First name" className="w-1/2  bg-white p-2 border rounded" />
          <input type="text" placeholder="Last Name" className="w-1/2 bg-white p-2 border rounded" />
        </div>
        <input type="text" placeholder="user name" className="w-full p-2 bg-white border rounded" />
